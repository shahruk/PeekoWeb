...
function initialize(){
	...
	function startCountdown(){
		$("#productOverlay").html("<div class='clearfix'> <button id='close' type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button> </div> <div class='row'> <div class='col-md-6'> <img id='productImage' src='' /> </div> <div class='col-md-6'> <h3 id='productName'></h3> <!-- <a href='#' class='btn btn-primary' id='share'><span class='glyphicon glyphicon-share'></span> Share This </a> --> <h3 style='margin-top: 0;'><span id='price'>0.00</span></h3> <hr /> <div class='col-md-2 col-xs-2'> <div id='vote'> <div id='topic' class='upvote'> <a class='upvote'></a> <span class='count'>5</span> <a class='downvote'></a> <!-- <a class='star starred'></a> --> </div> </div> </div><div class='row'><div class='col-md-10 col-xs-10'> <div id='description'> </div> </div> </div> <hr /> <img id='storeLogo' /> <a href='http://google.com/' class='btn btn-success' target='_system' id='buyOnline'><span class='glyphicon glyphicon-shopping-cart'></span> Visit Website</a> <div id='countdown'></div> </div> </div>");
